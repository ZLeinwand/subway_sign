...
while True:
	try:
		...
		for stop in STOP_IDS:
			...
			os.system('sudo ./rpi-rgb-led-matrix/examples-api-use/demo -r 16 -c 2 -t 5 -b 50 -D 1 -m 5000 dynamicimages/dynamictime.ppm --led-no-hardware-pulse --led-gpio-mapping=adafruit-hat')
	except Exception:
