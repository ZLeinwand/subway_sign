...
while True:
	...
	try:
		...
		os.system("sudo ./rpi-rgb-led-matrix/examples-api-use/demo --led-chain=4 -D 2 -t 1 -m 10 dynamicimages/dynamictime.ppm --led-no-hardware-pulse --led-gpio-mapping=adafruit-hat")
		# time.sleep(10)
